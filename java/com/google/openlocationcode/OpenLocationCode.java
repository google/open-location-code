...
public class OpenLocationCode {
  ...
  /**
   *  Never used, forces clients to use public static methods to instantiate objects.
   */
   ...
   */
  private OpenLocationCode(String code) {
    if (!isValidCode(code)) {
  ...
  /**
   * Creates a new OpenLocationCode from the provided code.
   */
  public static OpenLocationCode of(String code) {
  ...
  public OpenLocationCode recover(double referenceLatitude, double referenceLongitude) {
    ...
    String recoveredPrefix = new OpenLocationCode(referenceLatitude, referenceLongitude).getCode()
    ...
    return new OpenLocationCode(recoveredLatitude, recoveredLongitude,
        recovered.getCode().length() - 1);
  }
