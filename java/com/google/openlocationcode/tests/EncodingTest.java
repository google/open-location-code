...
public class EncodingTest {
  ...
  public void testDecode() {
    for (TestData testData : testDataList) {
      OpenLocationCode.CodeArea decoded = OpenLocationCode.of(testData.code).decode();
  ...
  public void testContains() {
    for (TestData testData : testDataList) {
      OpenLocationCode olc = OpenLocationCode.of(testData.code);
      ...
      Assert.assertTrue("Containment relation is broken for the decoded bottom left corner of code "
          + testData.code,
          olc.contains(decoded.getSouthLatitude(), decoded.getWestLongitude()));
      Assert.assertFalse("Containment relation is broken for the decoded top right corner of code "
          + testData.code,
