...
public class ShorteningTest {
  ...
  public void testShortening() {
    for (TestData testData : testDataList) {
      ...
      OpenLocationCode shortened = olc
          .shorten(testData.referenceLatitude, testData.referenceLongitude);
  ...
  public void testRecovering() {
    for (TestData testData : testDataList) {
      OpenLocationCode olc = OpenLocationCode.of(testData.shortCode);
      OpenLocationCode recovered = olc
          .recover(testData.referenceLatitude, testData.referenceLongitude);
