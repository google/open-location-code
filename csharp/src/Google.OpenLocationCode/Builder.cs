...
namespace Google.OpenLocationCode
{
    internal static class Builder
    {
        ...
        internal static double ClipLatitude( double latitude )
        {
...
// TODO: might need to move clip and normalize to somewhere else... it's weird they are in a Builder class and used outside