...
{
    public sealed class OpenLocationCodeBounds
    {
        ...
        public OpenLocationCodeBounds( decimal southLatitude, decimal westLongitude, decimal northLatitude, decimal eastLongitude )
        {
